...
public class ShareFileUtils {
    ...
    public static void shareImageToWeChatFriend(Context context, String path) {
        ...
        shareImage(context, path, null, "com.tencent.mm",
    ...
    public static void shareImageToWeChatFriend(Context context, List<String> pathList) {
        ...
        shareImage(context, null, pathList, "com.tencent.mm",
                "com.tencent.mm.ui.tools.ShareToTimeLineUI");
    }
    ...
    public static void shareImageToQZone(Context context, String path) {
        ...
        shareImage(context, path, null, "com.qzone",
    ...
    public static void shareImageToQZone(Context context, List<String> pathList) {
        ...
        shareImage(context, null, pathList, "com.qzone",
                "com.qzonex.module.operation.ui.QZonePublishMoodActivity");
    }
     ...
     */
    private static void shareImage(Context context, String path, List<String> pathList, String pkg,
            String cls) {
